                    ...
                    <div class="card card-warning">
                        ...
                        <div class="card-body">
                            <form method="POST" action="">
                                                  ...
                                                  <div class="form-divider">We will send a link to reset your password</div>

                                <div class="form-group">
                                    <label for="email">Email</label>
                    <input id="email" type="email" class="form-control" name="email" tabindex="1" required autofocus style="background-color:#787980;color: #fff;">
                                    
                                </div>
                    
                 
                                <div class="form-group">
         <button type="submit" name="next" class="btn btn-success btn-lg btn-block" tabindex="4" style="background-color: #FFA40B;">
                                    NEXT
                                    </button>
                                </div>
                            </form>
