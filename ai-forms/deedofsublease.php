        ...
        <div class="container mt-5">
            <div class="row">
                <div class="col-12 col-sm-10 offset-sm-1 col-md-8 offset-md-2 col-lg-8 offset-lg-2 col-xl-8 offset-xl-2">
                    ...
                    <div class="card card-primary">
                        <div class="card-header text-center">
                            <h2>FORM FOR DEED OF SUB-LEASE</h2>
                        </div>
                        <div class="card-body">
                            <form method="POST" action="">
                           <div class="form-group">
                                    <label for="email">Full Name of Sub-Lessor:</label>
                                    ...
                                    <div class="form-group col-12">
                                        <label for="bankname" class="d-block" >Address Of Sub-Lessor:</label> 
                                        <textarea id="addition" class="form-control" name="addressofdonor" rows="5" required></textarea>  
                                    </div>

                                    <div class="form-group col-12">
                                        <label for="fname" class="d-block">Full Name Of Sub-Lessee:</label>
                                        <input id="fname" type="text" class="form-control" name="fname" required="" >
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-12">
                                        <label>Address of Sub-Lesse:</label>
                                ...
                                <div class="form-group">
                                  <label for="addition">Commencement Date:</label>
                                   <input id="addition" type="date" class="form-control" name="c_date" rows="5" required>
                                                </div>
                                    ...
                                    <div class="form-group col-12">
                                        ...
                                        <input type="text" class="form-control"  name="consideramt" required="">
                                    </div>
                                    <div class="form-group col-12">
                                        <label>Duration of Lease:</label>
                                        <input type="text" class="form-control"  name="surveyorname" required="">
                                    </div>
                                    <div class="form-group col-12">
                                        <label>Purpose:</label>
                                        <select class="form-control selectric" name="purpose" required="" autofocus>
                ...
                <option value="residential">Residential</option>
                                ...
                                <div class="row">
                                    <div class="form-group col-12">
                                        <label>Duration of Statutoty Notice:</label>
