                ...
                <div class="col-12 col-sm-10 offset-sm-1 col-md-8 offset-md-2 col-lg-8 offset-lg-2 col-xl-8 offset-xl-2">
                    ...
                    <div class="card card-primary">
                        <div class="card-header text-center">
                            <h2>FORM FOR RETAINERSHIP AGREEMENT</h2>
                        </div>
                        <div class="card-body">
                            <form method="POST" action="">
                           <div class="form-group">
                                    <label for="email">Full Name of Retainer:</label>
                                  ...
                                  <label for="addition">Duration Of Time:</label>
                                   <input id="addition" type="text" class="form-control" name="c_date" rows="5" required>
                                    ...
                                    <div class="form-group col-12">
                                        ...
                                        <input type="date" class="form-control" name="addressofdonee" required="">
                                    </div>
                                    <div class="form-group col-12">
