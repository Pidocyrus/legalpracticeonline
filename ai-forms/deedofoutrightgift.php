                ...
                <div class="col-12 col-sm-10 offset-sm-1 col-md-8 offset-md-2 col-lg-8 offset-lg-2 col-xl-8 offset-xl-2">
                    ...
                    <div class="card card-primary">
                        <div class="card-header text-center">
                            <h2>FORM FOR DEED OF OUTRIGHT GIFT</h2>
                        </div>
                        <div class="card-body">
                            <form method="POST" action="">
                           <div class="form-group">
                                    <label for="email">Full Name of Donor/Giver:</label>
                                    ...
                                    <div class="form-group col-12">
                                        <label for="bankname" class="d-block" >Address Of Donor/Giver:</label> 
                                        <textarea id="addition" class="form-control" name="addressofdonor" rows="5" required></textarea>  
                                    </div>

                                    <div class="form-group col-12">
                                        <label for="fname" class="d-block">Full Name Of Beneficiary/Receiver:</label>
                                        <input id="fname" type="text" class="form-control" name="fname" required="" >
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-12">
                                        <label>Address of Beneficiary/Receiver:</label>
                                ...
                                <div class="form-group">
                                  <label for="addition">Relationship:</label>
