                ...
                <div class="col-12 col-sm-10 offset-sm-1 col-md-8 offset-md-2 col-lg-8 offset-lg-2 col-xl-8 offset-xl-2">
                    ...
                    <div class="card card-primary">
                        <div class="card-header text-center">
                            <h2>FORM FOR IRREVOCABLE POWER OF ATTORNEY</h2>
                        </div>
                        <div class="card-body">
                            <form method="POST" action="">
                           <div class="form-group">
                                    <label for="email">Full Name of Donor:</label>
                                ...
                                <div class="form-group">
                                  <label for="addition">Recital(History of the Land Ownership):</label>
                                ...
                                <div class="row">
                                    <div class="form-group col-12">
                                        <label>State Where The of the Federation Where The Land is Situated:</label>
                                ...
                                <div class="form-group">
                                  <label for="addition">Beacon Numbers:</label>
                                   <textarea id="addition" class="form-control" name="addition" rows="5" required> </textarea>
                                           <div class="invalid-feedback"></div>
                                                  </div>
                                                </div>
